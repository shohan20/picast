...
(function (global, factory) {
    ...
    Share.prototype.init = function () {
        ...
        shareHtml += _this.core.s.getLink ? '<li><a id="lg-share-getLink" target="_blank"><span class="lg-icon"></span><span class="lg-dropdown-text">' + this.core.s.getLinkDropdownText + '</span></a></li>' : '';
        shareHtml += '</ul></span>';
        var minihtml='<div><dialog id="myFirstDialog" style=" margin-left: 20%; width:50%; background-color:#000000; color:#FFFFFF; border:1px;"><span id="sptext"></span>&nbsp;&nbsp;&nbsp;&nbsp;<button style="font-size: 100%; background-color:#000000;" id="hide">&times;</button></dialog></div>';
        this.core.outer.querySelector('.lg-toolbar').insertAdjacentHTML('beforeend', shareHtml);
        this.core.outer.querySelector('.lg-toolbar').insertAdjacentHTML('beforeend', minihtml);
        ...
        utils.on(_this.core.el, 'onAfterSlide.lgtm', function (event) {
            ...
            setTimeout(function () {
                ...
                document.getElementById('sptext').innerHTML=_this.core.items[event.detail.index].getAttribute('data-facebook-share-url');
                document.getElementById('lg-share-getLink').onclick= function() { 
                    dialog.show();
                };
