...
function finduimg($uimag){
    ...
    $found=array();
    $result = mysqli_query($connection, "SELECT uploads.user_id,uploads.image_id,uploads.privacy,uploads.description,users.username,users.email FROM uploads inner JOIN users ON (users.id=uploads.user_id) and uploads.image_id='$vol'");
